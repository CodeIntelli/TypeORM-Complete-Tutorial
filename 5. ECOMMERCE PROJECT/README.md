...
class Category(models.Model):
    ...
    def __str__(self):
        return str(self.productCategory)
...
class subCategory(models.Model):
    ...
    def __str__(self):
        return str(self.productSubCategory)
...
class Product(models.Model):
    ...
    @property
    def percentage(self):
        a = self.selling_price - self.discount_price
        actual = a/self.selling_price
        return math.trunc(actual * 100)
...
class CancledOrders(models.Model):
    ...
    reason = models.CharField(choices=CANCLE_CHOICES, max_length=50)
...
class ReturnOrders(models.Model):
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    orderplaced = models.ForeignKey(OrderPlaced, on_delete=models.CASCADE)
    rreason = models.CharField(choices=RETURN_CHOICES, max_length=150)
